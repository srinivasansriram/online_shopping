...
INSERT INTO CATEGORY(name,description,image_url,is_active) values('Mobile','this is a description of mobile','CAT_3.png',true);
INSERT INTO CATEGORY(name,description,image_url,is_active) values('Laptop','this is a description of mobile','CAT_2.png',true);
INSERT INTO CATEGORY(name,description,image_url,is_active) values('television','this is a description of mobile','CAT_1.png',true);
